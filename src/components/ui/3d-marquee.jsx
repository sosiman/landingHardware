                                    ...
                                    return (
                                        <div key={`img-${imgIdx}`} className="relative">
                                            ...
                                            <motion.img
                                                ...
                                                width={970}
                                                height={700}
                                                className={`aspect-[970/700] w-full rounded-lg object-cover ring ring-gray-300/30 dark:ring-gray-800/50 shadow-xl hover:shadow-2xl transition-shadow duration-300 ${isClickable ? "cursor-pointer" : ""
                                                    }`}
